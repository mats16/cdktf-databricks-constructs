...
### Network <a name="Network" id="cdktf-databricks-constructs.Network"></a>

#### Initializers <a name="Initializers" id="cdktf-databricks-constructs.Network.Initializer"></a>

```typescript
import { Network } from 'cdktf-databricks-constructs'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdktf-databricks-constructs.Network.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.Network.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.Network.Initializer.parameter.config">config</a></code> | <code><a href="#cdktf-databricks-constructs.NetworkConfig">NetworkConfig</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="cdktf-databricks-constructs.Network.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="cdktf-databricks-constructs.Network.Initializer.parameter.id"></a>

- *Type:* string

---

##### `config`<sup>Required</sup> <a name="config" id="cdktf-databricks-constructs.Network.Initializer.parameter.config"></a>

- *Type:* <a href="#cdktf-databricks-constructs.NetworkConfig">NetworkConfig</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdktf-databricks-constructs.Network.toString">toString</a></code> | Returns a string representation of this construct. |

---

##### `toString` <a name="toString" id="cdktf-databricks-constructs.Network.toString"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdktf-databricks-constructs.Network.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### `isConstruct` <a name="isConstruct" id="cdktf-databricks-constructs.Network.isConstruct"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="cdktf-databricks-constructs.Network.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdktf-databricks-constructs.Network.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#cdktf-databricks-constructs.Network.property.accountId">accountId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.Network.property.networkId">networkId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.Network.property.networkName">networkName</a></code> | <code>string</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="cdktf-databricks-constructs.Network.property.node"></a>
...
##### `accountId`<sup>Required</sup> <a name="accountId" id="cdktf-databricks-constructs.Network.property.accountId"></a>
...
##### `networkId`<sup>Required</sup> <a name="networkId" id="cdktf-databricks-constructs.Network.property.networkId"></a>
...
##### `networkName`<sup>Required</sup> <a name="networkName" id="cdktf-databricks-constructs.Network.property.networkName"></a>
...
### NetworkConfig <a name="NetworkConfig" id="cdktf-databricks-constructs.NetworkConfig"></a>

#### Initializer <a name="Initializer" id="cdktf-databricks-constructs.NetworkConfig.Initializer"></a>

```typescript
import { NetworkConfig } from 'cdktf-databricks-constructs'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#cdktf-databricks-constructs.NetworkConfig.property.databricksAccountId">databricksAccountId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.NetworkConfig.property.provider">provider</a></code> | <code>@cdktf/provider-databricks.provider.DatabricksProvider</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.NetworkConfig.property.securityGroupIds">securityGroupIds</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.NetworkConfig.property.subnetIds">subnetIds</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.NetworkConfig.property.vpcId">vpcId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#cdktf-databricks-constructs.NetworkConfig.property.networkName">networkName</a></code> | <code>string</code> | *No description.* |

---

##### `databricksAccountId`<sup>Required</sup> <a name="databricksAccountId" id="cdktf-databricks-constructs.NetworkConfig.property.databricksAccountId"></a>
...
##### `provider`<sup>Required</sup> <a name="provider" id="cdktf-databricks-constructs.NetworkConfig.property.provider"></a>
...
##### `securityGroupIds`<sup>Required</sup> <a name="securityGroupIds" id="cdktf-databricks-constructs.NetworkConfig.property.securityGroupIds"></a>
...
##### `subnetIds`<sup>Required</sup> <a name="subnetIds" id="cdktf-databricks-constructs.NetworkConfig.property.subnetIds"></a>
...
##### `vpcId`<sup>Required</sup> <a name="vpcId" id="cdktf-databricks-constructs.NetworkConfig.property.vpcId"></a>
...
##### `networkName`<sup>Optional</sup> <a name="networkName" id="cdktf-databricks-constructs.NetworkConfig.property.networkName"></a>
